package com.powervault.health.pro.service
...
import com.powervault.health.pro.MainActivity
import com.powervault.health.pro.PowerVaultApplication
import com.powervault.health.pro.R
import com.powervault.health.pro.data.db.AppDatabase
...
import com.powervault.health.pro.util.BatteryUtils
...
class BatteryMonitorService : Service() {
    ...
    private fun fireAlert(rule: RuleEntity) {
        ...
        val notification = NotificationCompat.Builder(this, PowerVaultApplication.CHANNEL_ALERT)
    ...
    private fun buildNotification(text: String): Notification {
        ...
        return NotificationCompat.Builder(this, PowerVaultApplication.CHANNEL_MONITOR)
